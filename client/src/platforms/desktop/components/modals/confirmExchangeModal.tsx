...
import {confirmExchange, resetExchangeProcess} from "platforms/desktop/actions";
...
class ConfirmExchangeModal extends React.Component<ConfirmExchangeModalProps, any> {
    ...
    render() {
        ...
        const {address, fromAmount, toAmount, fromTicker, toTicker} = this.props.exchange;
