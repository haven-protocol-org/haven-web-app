...
export class GraphTicker extends Component {
    ...
    render() {
        ...
        const pricePointString = chartPoints.map(pricePoint => `${pricePoint[0]},${pricePoint[1]}`);
        ...
        return (
        <svg style={{marginTop:'10px',display:'block', marginBottom:'0', padding:'0'}} width={'100%'} height={containerHeight} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio={"none"}>
                <polyline points={pricePointString} style={{fill:'none',stroke:"rgba(114, 137, 218, 1)", strokeLinecap:"butt",strokeWidth:"2px", shapeRendering:"geometricPrecision"}} />
                <polyline points={chartPointString} style={{stroke:'none', fill:'rgba(114, 137, 218, 0.20)'}} />
            </svg>)
