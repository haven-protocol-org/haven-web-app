...
import {Header, Section, Subtitle, Title} from "../../../../universal/pages/_public/welcome/styles";
...
class ScrollTicker extends Component {
  ...
  render() {
    ...
    const tickerList = Object.entries(this.props.xhvVsCurrencies).filter( entry => {
